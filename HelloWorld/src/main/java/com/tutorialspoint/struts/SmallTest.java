...
import main.java.com.tutorialspoint.struts.FibonacciTest.Fibonacci;
...
public class SmallTest {
	...
	public static void main(String[] args) {
		...
		kbuilder.add(ResourceFactory.newClassPathResource("main/rules/com/tutorialspoint/structs/newRule.drl",
