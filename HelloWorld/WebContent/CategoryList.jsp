...
<body>
    ...
    <ul class="nav">
        <li class="" ><a class="recordable open" href="#" id="toggleone"
            memo="{id:'21',type:'menu',global:1,status:''}">Manage Category</a>
            <ul class="nav-two" id="navone" >
                <li class="selected"><a href="<%=basePath%>gotocategorylist.action">Category List</a><span class="normal">&nbsp;</span></li>
    ...
    <div class="main"  id="main-body">
        ...
        <div class="title-bar clearfix">
            <h1 class="l">Manage Category</h1><div id="Date" class="date l"></div>
        ...
        <div>
            ...
            <a href="CreateCategory.html" class="button"> + New Category</a>
            <div class="r"><input type="text" class="searchtext" placeholder="Category name"/>
        ...
        <table cellspacing="0" cellpadding="0" class="list">
            <tbody><tr class="title">
                ...
                <tr>
                    ...
                    <td class="">Domestic product</td>
                    <td class=""><a class="button" href="RulePriority.html">View</a>  <a class="button" href="#">Edit</a></td>
                </tr>
                    <tr>
                    <td class=""><input type="checkbox" class="case"/></td>
                    <td class="">33</td>
                    <td class="">Category2</td>
                    <td class="">International product</td>
                    <td class=""><a class="button" href="#">View</a>  <a class="button" href="#">Edit</a></td>
                </tr>
                <tr class="last">
                    <td class=""><input type="checkbox" class="case"/></td>
                    <td class="">39</td>
                    <td class="">Category3</td>
                    <td class="">Pittsburgh Product</td>
                    <td class=""><a class="button" href="#">View</a>  <a class="button" href="#">Edit</a></td>
                </tr>
                </tbody>
            </table>
        ...
        <div id="cart1" class="cart">
            ...
            <div>&nbsp;&nbsp;Are you sure you want to delete the categry?</div>
