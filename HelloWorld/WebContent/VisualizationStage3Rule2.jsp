	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
					<div style="padding-left:30px;padding-top:30px;">
                        ...
                        <div id="included" style="height:60px;margin-top:30px;">
                            ...
                            <div>
                                <div name="packages" style="float:left;padding-left:20px;height:20px;font-size:12px;">Package 2&#58; </div>
                                <div name="items" style="float:left;">
                                    <div name="item" style="padding-left:30px;height:20px;font-size:12px;">Golf Bag - quantity 1</div>
                                </div>
                            </div>
                        </div>
